...
<head>
  ...
  <meta id="session_id" name="user-id" content="{{ (session('id')) ? session('id') : '' }}">
...
<div class="wrapper" id="app">
  ...
  @else
   @php
    ...
    @endphp
  @endif
  <div class="login_condition" style = "{{$div_class}}">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <router-link to="conductor" class="nav-link">
  ...
  <div id = "content_div_after_login" class="test {{$clas}}">
